                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">A listed out of Customer from company .</p>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                  @foreach($customer_req_list as $item)
                        <tr>
                            ...
                            <div style="display: flex; align-items: center;">
                                <a href="{{ route('edit_c', $item->id) }}" class="btn btn-success rounded-pill m-2">Active Account</a>
                            </div>
                           </td>
                        </tr>
                                 @endforeach 
