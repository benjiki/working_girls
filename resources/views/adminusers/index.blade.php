...
<!-- Mirrored from zuramai.github.io/mazer/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 17:48:15 GMT -->
<!-- Added by HTTrack -->
...
<body>
    <script src="{{('adminassets/assets/static/js/initTheme.js')}}"></script>
    <div id="app">
        <div id="sidebar">
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-muted font-semibold">All Order Requests</h6>
                                                <h6 class="font-extrabold mb-0">{{$total_req}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from zuramai.github.io/mazer/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 17:48:39 GMT -->
