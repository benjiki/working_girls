            ...
            <div class="page-heading">
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <tr>
                            <td>{{ substr($item->customer_username, 0, 20) }}{{ strlen($item->customer_username) > 20 ? '...' : '' }}</td>
                            <td>{{ substr($item->customer_phone, 0, 20) }}{{ strlen($item->customer_phone) > 20 ? '...' : '' }}</td>
                            <td>{{ substr($item->orderd_worker_name, 0, 20) }}{{ strlen($item->orderd_worker_name) > 20 ? '...' : '' }}</td>
                            <td>{{ substr($item->orderd_worker_phone, 0, 20) }}{{ strlen($item->orderd_worker_phone) > 20 ? '...' : '' }}</td>
                            <td>{{ substr($item->orderstatus, 0, 20) }}{{ strlen($item->orderstatus) > 20 ? '...' : '' }}</td>
                            
                            <td>{{ $item->created_at }}</td>
                            <td>{{ $item->updated_at }}</td>                          
                            <td>
                                <div style="display: flex; align-items: center;">
                                    <form action="{{ route('accept_order', ['id' => $item->id]) }}" method="POST">
                                        @csrf
                                ...
                                <div style="display: flex; align-items: center;">
                                    <form action="{{ route('reject_order', ['id' => $item->id]) }}" method="POST">
                                        @csrf
                                        @method('POST') <!-- Use POST method -->
