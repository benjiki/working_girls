    ...
    <section class="home-slider-area">
      <div class="swiper-container swiper-slide-gap home-slider-container default-slider-container">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
          @foreach ($latest_worker as $item)
          <div class="swiper-slide">
            <div class="slider-content-area" data-bg-img="{{asset('storage/images/worker_profile/'.$item->workerphoto)}}">
              <div class="slider-content">
                <h2 class="title">{{$item->workername}}</h2>
                <p>age {{$item->workerage}}.</p>
                <a class="btn-slider" href="shop.html">Request Now</a>
              </div>
            </div>
          </div>
          @endforeach
